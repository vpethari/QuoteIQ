...
_DIMENSION_EXPR = re.compile(
    ...
    + r"""
      ...
      |
        ...
        # PVC candidate's own dimension against any query size that wasn't
        # exactly 1/2" -- capping their score and letting an unrelated,
        # differently-sized candidate outrank them.
...
# A denominator a genuine imperial fraction size actually uses in this
# catalog -- confirmed live: of ~24,400 quote-marked fraction sizes
# ("N/D\""), 99.99% use one of these six; the two stray outliers (7, 5)
# are noise. Real-world spec ratios/ratings that happen to look like a
